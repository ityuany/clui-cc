  ...
  return (
    ...
    >
      ...
      <span className="text-[11px]" style={{ color: colors.textTertiary }}>
        Press <strong style={{ color: colors.textSecondary }}>⌘ + Shift + K</strong> to show/hide this overlay
      </span>
    </div>
  )
}
        ...
        <div className="relative pl-6">
          ...
          <div className="space-y-3">
            {tools.map((tool) => {
              ...
              // Parse once for both description and detail content
                          ...
                          >
                            {oldStr !== null && (
                              <pre
                                ...
                                aria-label="Removed"
                                style={{ background: colors.diffRemovedBg, color: colors.textSecondary, maxHeight: 120, margin: 0, fontFamily: monoFont, fontSize: 10 }}
                            ...
                            {newStr !== null && (
                              <pre
                                className="px-2 py-1 whitespace-pre-wrap break-all overflow-y-auto"
                                aria-label="Added"
                                style={{ background: colors.diffAddedBg, color: colors.textSecondary, maxHeight: 120, margin: 0, fontFamily: monoFont, fontSize: 10 }}
                      ...
                      if (toolName === 'Write' && typeof parsedInput.content === 'string') {
                        ...
                        return (
                          <pre
                            ...
                            style={{ background: colors.surfaceHover, color: colors.textSecondary, maxHeight: 120, margin: 0, marginTop: 4, fontFamily: monoFont, border: `1px solid ${colors.toolBorder}` }}
                          >{snippet}</pre>
                        )
                      }
                      return null
